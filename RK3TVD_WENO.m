function [U_final, F_final]=RK3TVD_WENO(inp, U, F)
% Third Order TVD Runge Kutta with classic forth order WENO scheme
...
dU_dt=-eulerWeno(inp, U1, F_final);
...
dU_dt=-eulerWeno(inp, U2, F_final);
